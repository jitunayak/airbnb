...
function RoomPage() {
  ...
  const {
    ...
    isError,
    isLoading,
  } = useQuery({ queryFn: () => roomsApi.getRoomById(roomId), queryKey: ['room', roomId] });
          ...
          <BookingContainer>
            ...
            >
              ...
              >
                ...
                <div
                  style={{ backgroundColor: 'lightgray', height: '1.4px' }}
                />
              </Row>
              ...
              {showGuestDetails && (
                <GuestsContainer>
                  ...
                  <GuestRow>
                    ...
                    <CounterContainer>
                      <CircularIcon onClick={removeChildrenGuest}>
                        -
                      </CircularIcon>
            ...
            {sendBookingConfirmation.isPending ||
              ...
              <ReserveButton onClick={() => handleReserve()}>
                ...
                {sendBookingConfirmation.isPending
                  ? 'Reserving...'
                  : `${moment(reserveDates.checkIn).format('DD MMM')}-${moment(
                    reserveDates.checkOut
                  ).format('DD MMM')}-Reserve`}{' '}
              </ReserveButton>
            )}
